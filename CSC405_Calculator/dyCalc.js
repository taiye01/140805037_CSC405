...
function compute(form) {
    form.display.value = new Function("return " + form.display.value)();
}


function square(form) {
    form.display.value = new Function("return " + form.display.value)() * new Function("return " + form.display.value)();
}
